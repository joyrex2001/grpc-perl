...
ok( $new->getClockType()==Grpc::XS::Constants::GPR_CLOCK_REALTIME,"ClockType = GPR_CLOCK_REALTIME");
...
ok( $zero->getClockType()==Grpc::XS::Constants::GPR_CLOCK_REALTIME,"ClockType = GPR_CLOCK_REALTIME");
